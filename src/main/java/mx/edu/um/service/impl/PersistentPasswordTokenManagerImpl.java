...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see mx.edu.um.service.impl.PasswordTokenManager#generateRecoveryToken(mx.edu.um.model.User)
     */
    @Override
    ...
    /**
     * @see mx.edu.um.service.impl.PasswordTokenManager#isRecoveryTokenValid(mx.edu.um.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see mx.edu.um.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
